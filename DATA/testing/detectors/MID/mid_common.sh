...
MID_CALIB_OUTSPEC="downstreamA:MID/DATA/1;downstreamB:MID/DATA/2;downstreamC:MID/DATAROF/1;downstreamD:MID/DATAROF/2"
MID_CALIB_PROXY_INSPEC="${MID_CALIB_OUTSPEC//"downstream"/""};$MID_PROXY_INSPEC_EOS"
...
MID_CALIB_OUT_CHANNEL_CONFIG="name=mid-noise-input-proxy,method=connect,type=push,transport=zeromq,rateLogging=0"
MID_CALIB_IN_CHANNEL_CONFIG="name=mid-noise-input-proxy,method=bind,type=pull,rateLogging=0,transport=zeromq"
