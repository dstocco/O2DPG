...
#############
# My settings
# export GEN_TOPO_LIBRARY_FILE=testing/detectors/MID/workflows.desc
export GEN_TOPO_LIBRARY_FILE=production/standalone-calibration.desc
export WORKFLOW_DETECTORS=MID
export WORKFLOW_DETECTORS_CALIB=MID
export WORKFLOW_DETECTORS_RECO=MID

# export GEN_TOPO_WORKFLOW_NAME=mid-calib-workflow
export GEN_TOPO_WORKFLOW_NAME=MID-calib-workflow
# export GEN_TOPO_WORKFLOW_NAME=mid-raw-to-ctf-qc-workflow
